  ...
  return (
    <div className="grow">
      ...
      <div className="p-6 space-y-6">
        <h2 className="text-2xl text-slate-800 font-bold mb-5">Mi cuenta</h2>
        {/* Picture */}
        <section>
          <div className="flex items-center">
            ...
            <button className="btn-sm bg-primary hover:bg-indigo-600 text-white">Cambiar</button>
          </div>
        </section>
        {/* Business Profile */}
        <section>
          <h2 className="text-xl leading-snug text-slate-800 font-bold mb-1">Perfil</h2>
        ...
        <section>
          ...
          <div className="flex flex-wrap mt-5">
            ...
            <button className="btn border-slate-200 hover:border-slate-300 shadow-sm text-primary">Change</button>
          </div>
        </section>
        {/* Password */}
        <section>
          ...
          <div className="mt-5">
            <button className="btn border-slate-200 shadow-sm text-primary">Set New Password</button>
          </div>
        </section>
        {/* Smart Sync */}
        <section>
